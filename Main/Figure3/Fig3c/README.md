...
reorder=df[order(df$chr5_21405867, decreasing=FALSE), ]
reorder=reorder%>%filter(chr5_21405867!='.')
ggmap(mapacc) +
  labs(x = 'Longitude', y = 'Latitude',color = "chr5:21405867",shape=3) +
  geom_point(data=reorder, aes(x = Longitude,y = Latitude, color = chr5_21405867),
             size=1,alpha=0.6) +
